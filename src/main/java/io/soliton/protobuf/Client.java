 ...
 *
 * <p>A client's responsibility is to encode a method call and return a handle on the upcoming
 * response from the server. The protocol and transport used to accomplish this task are specific
 * to each client-server implementation.</p>
 *
