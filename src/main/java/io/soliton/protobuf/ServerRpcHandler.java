 ...
 *
 */
public class ServerRpcHandler extends SimpleChannelInboundHandler<Envelope> {

  public static final Logger logger = Logger.getLogger(ServerRpcHandler.class.getCanonicalName());

  private final ConcurrentMap<Long, ListenableFuture<?>> pendingRequests = new MapMaker().makeMap();
  private final ServiceGroup serviceGroup;

  ServerRpcHandler(ServiceGroup serviceGroup) {
